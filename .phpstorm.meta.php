...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\ruben\Herd\forumSecond\public\storage' => 'string',
            'image.driver' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\ruben\\Herd\\forumSecond\\public\\storage','image.driver','image.options.autoOrientation','image.options.decodeAnimation',
'image.options.blendingColor','image.options.strip','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','purifier.encoding',
...
'purifier.settings.custom_attributes.0','purifier.settings.custom_elements.0','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'scout.typesense.model-settings','scout.typesense.import_action','services.postmark.token','services.resend.key','services.ses.key',
...
'debugbar.debug_backtrace_limit','livewire.component_locations','livewire.component_namespaces.layouts','livewire.component_namespaces.pages','livewire.component_layout',
...
'livewire.upload-file','livewire.preview-file','home','forums.show','threads.show','threads.create',
'threads.store','threads.destroy','posts.store','threads.post.destroy','profile.post.destroy',
'profile.post.update','thread.post.update','register','register.store','login',
'login.store','logout.destroy','search','members.index','members.following',
'members.followers','users.show','users.follow','users.unfollow','users.destroy',
'avatar.update','avatar.destroy','settings.personal','settings.privacy','settings.threads',
'settings.conversations','conversation.create','conversation.store','conversation.show','conversation.leave',
'conversation.invite','conversation.accept','conversation.reject','notifications.index','notifications.read',
'notifications.read.all','notification.jump','conversation.message.update','message.store','message.destroy',
'storage.local',);
        registerArgumentsSet('views', 
'89127184a756b50aae262c2677a5e924::actions.delete-button','89127184a756b50aae262c2677a5e924::divide','89127184a756b50aae262c2677a5e924::editor','89127184a756b50aae262c2677a5e924::footer','89127184a756b50aae262c2677a5e924::forms.date',
'89127184a756b50aae262c2677a5e924::forms.div','89127184a756b50aae262c2677a5e924::forms.form-button','89127184a756b50aae262c2677a5e924::forms.form-error','89127184a756b50aae262c2677a5e924::forms.input','89127184a756b50aae262c2677a5e924::forms.profile-image',
'89127184a756b50aae262c2677a5e924::forms.radio-group','89127184a756b50aae262c2677a5e924::header','89127184a756b50aae262c2677a5e924::layout','89127184a756b50aae262c2677a5e924::link','89127184a756b50aae262c2677a5e924::livewire.profile.⚡activity',
'89127184a756b50aae262c2677a5e924::livewire.profile.⚡posts','89127184a756b50aae262c2677a5e924::livewire.profile.⚡reply','89127184a756b50aae262c2677a5e924::livewire.profile.⚡show','89127184a756b50aae262c2677a5e924::livewire.⚡forum-show','89127184a756b50aae262c2677a5e924::livewire.⚡notifications-index',
'89127184a756b50aae262c2677a5e924::livewire.⚡user-search','89127184a756b50aae262c2677a5e924::main','89127184a756b50aae262c2677a5e924::nav-link','89127184a756b50aae262c2677a5e924::post','89127184a756b50aae262c2677a5e924::reply',
'89127184a756b50aae262c2677a5e924::settings.aside','89127184a756b50aae262c2677a5e924::time-display','89127184a756b50aae262c2677a5e924::user-link','89127184a756b50aae262c2677a5e924::user-menu','actions.delete-button',
'auth.login','auth.register','components.actions.delete-button','components.divide','components.editor',
'components.footer','components.forms.date','components.forms.div','components.forms.form-button','components.forms.form-error',
'components.forms.input','components.forms.profile-image','components.forms.radio-group','components.header','components.layout',
'components.link','components.livewire.profile.⚡activity','components.livewire.profile.⚡posts','components.livewire.profile.⚡reply','components.livewire.profile.⚡show',
'components.livewire.⚡forum-show','components.livewire.⚡notifications-index','components.livewire.⚡user-search','components.main','components.nav-link',
'components.post','components.reply','components.settings.aside','components.time-display','components.user-link',
'components.user-menu','conversations.create','conversations.show','divide','editor',
'footer','forms.date','forms.div','forms.form-button','forms.form-error',
'forms.input','forms.profile-image','forms.radio-group','forums.show','header',
'home','icons.arrow-down','icons.arrow-right','icons.bell','icons.bell-alert',
'icons.cancel','icons.chat','icons.star','layout','link',
'livewire.profile.⚡activity','livewire.profile.⚡posts','livewire.profile.⚡reply','livewire.profile.⚡show','livewire.⚡forum-show',
'livewire.⚡notifications-index','livewire.⚡user-search','main','nav-link','notifications.dropdown',
'notifications.notifications','notifications.types.ConversationInvitationNotification','notifications.types.ConversationMessageNotification','notifications.types.ProfilePostNotification','notifications.types.ThreadPostNotification',
'pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui','pagination::simple-bootstrap-4',
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','post',
'reply','search.partials.post-profile','search.partials.post-reply','search.partials.post-thread','search.partials.thread',
'search.results','settings.aside','threads.create','threads.edit','threads.show',
'time-display','user-link','user-menu','users.conversations','users.followers',
'users.following','users.index','users.personal','users.privacy','users.show',
'users.threads','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default','vendor.pagination.semantic-ui',
...
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.ruben.Herd.forumSecond.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'DB_PASSWORD','SCOUT_DRIVER','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
