<div x-data="{ open: false }" @click.outside="open = false" class="relative z-10">
    ...
    <div x-show="open"
        ...
        class="p-2 absolute w-75 sm:80 top-full bg-gray-600/95 border transform
            -translate-y-2 transition-all border-gray-400/50 duration-300 right-0">
        <div class="flex">
            ...
            <ul class="p-2 flex-2 w-full">
                <li class="hover:opacity-75"><a class="hover:underline active:underline" href="{{ route('users.show', auth()->user()->id) }}">{{ auth()->user()->name }}</a></li>
            <li class="hover:opacity-75"><a class="hover:underline active:underline" href="{{ route('users.show', auth()->user()->id) }}">View Your Profile</a></li>
                <li class="hover:opacity-75"><a class="hover:underline active:underline flex" href="{{ route('notifications.index', auth()->user()) }}">Notifications</a></li>
            </ul>
